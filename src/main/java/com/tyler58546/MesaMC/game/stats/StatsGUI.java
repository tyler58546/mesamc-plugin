...
public class StatsGUI extends CustomGUI {
    ...
    static HashMap<Integer, ItemStack> getItems(MesaMC main, Player player) {
        ...
        output.put(31, new StatsItem(Material.ENDER_EYE, GameType.SKYWARS, player, main.statisticsManager));
        output.put(32, new StatsItem(Material.RED_BED, GameType.BEDWARS, player, main.statisticsManager));
        output.put(33, new StatsItem(Material.COOKIE, GameType.SLAPAROO, player, main.statisticsManager));
        return output;
    }
}
